...
#CONTROL
I_DFilt = np.array(job.GetSignalByName('Sc3:Sc3:SUM1 - inputs[0]').DataPoints)
I_DSetP = np.array(job.GetSignalByName('Sc3:Sc3:SUM1 - inputs[1]').DataPoints)
I_QFilt = np.array(job.GetSignalByName('Sc3:Sc3:SUM1 - inputs[0]').DataPoints)
I_QSetP = np.array(job.GetSignalByName('Sc3:Sc3:SUM1 - inputs[1]').DataPoints)
#FEEDFORWARD
V_DCtrl = np.array(job.GetSignalByName('Sc3:SUM1 - inputs[0]').DataPoints)
V_Dfeed = np.array(job.GetSignalByName('Sc3:SUM1 - inputs[1]').DataPoints)
V_QCtrl = np.array(job.GetSignalByName('Sc3:SUM2 - inputs[0]').DataPoints)
V_Qfeed = np.array(job.GetSignalByName('Sc3:SUM2 - inputs[1]').DataPoints)
#SHAPING
...
#MODULATOR
V_MOD1 = np.array(job.GetSignalByName('Sc3:SUM3 - Out').DataPoints)
V_MOD2 = np.array(job.GetSignalByName('Sc3:SUM4 - Out').DataPoints)
V_MOD3 = np.array(job.GetSignalByName('Sc3:SUM5 - Out').DataPoints)
