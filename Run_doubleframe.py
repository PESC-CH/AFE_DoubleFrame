...
#CONTROL
I_DposFilt = np.array(job.GetSignalByName('Sc3:Sc5:SUM1 - inputs[0]').DataPoints)
I_DposSetP = np.array(job.GetSignalByName('Sc3:Sc5:SUM1 - inputs[1]').DataPoints)
I_QposFilt = np.array(job.GetSignalByName('Sc3:Sc6:SUM1 - inputs[0]').DataPoints)
I_QposSetP = np.array(job.GetSignalByName('Sc3:Sc6:SUM1 - inputs[1]').DataPoints)
I_DnegFilt = np.array(job.GetSignalByName('Sc3:Sc14:SUM1 - inputs[0]').DataPoints)
I_DnegSetP = np.array(job.GetSignalByName('Sc3:Sc14:SUM1 - inputs[1]').DataPoints)
I_QnegFilt = np.array(job.GetSignalByName('Sc3:Sc15:SUM1 - inputs[0]').DataPoints)
I_QnegSetP = np.array(job.GetSignalByName('Sc3:Sc15:SUM1 - inputs[1]').DataPoints)
#FEEDFORWARD
V_DposCtrl = np.array(job.GetSignalByName('Sc3:SUM3 - inputs[0]').DataPoints)
V_Dposfeed = np.array(job.GetSignalByName('Sc3:SUM3 - inputs[1]').DataPoints)
V_QposCtrl = np.array(job.GetSignalByName('Sc3:SUM4 - inputs[0]').DataPoints)
V_Qposfeed = np.array(job.GetSignalByName('Sc3:SUM4 - inputs[1]').DataPoints)
V_DnegCtrl = np.array(job.GetSignalByName('Sc3:SUM5 - inputs[0]').DataPoints)
V_Dnegfeed = np.array(job.GetSignalByName('Sc3:SUM5 - inputs[1]').DataPoints)
V_QnegCtrl = np.array(job.GetSignalByName('Sc3:SUM6 - inputs[0]').DataPoints)
V_Qnegfeed = np.array(job.GetSignalByName('Sc3:SUM6 - inputs[1]').DataPoints)
#COMBINING
...
#SHAPING
V_Ctrl1 = np.array(job.GetSignalByName('Sc3:InvPark1 - A').DataPoints)
V_Ctrl2 = np.array(job.GetSignalByName('Sc3:InvPark1 - B').DataPoints)
V_Ctrl3 = np.array(job.GetSignalByName('Sc3:InvPark1 - C').DataPoints)
#MODULATOR
V_MOD1 = np.array(job.GetSignalByName('Sc3:SUM7 - Out').DataPoints)
V_MOD2 = np.array(job.GetSignalByName('Sc3:SUM8 - Out').DataPoints)
V_MOD3 = np.array(job.GetSignalByName('Sc3:SUM9 - Out').DataPoints)
...
fig14, (ax1,ax2) = plt.subplots(2, 1, sharex=True)
...
fig15, (ax1,ax2) = plt.subplots(2, 1, sharex=True)
ax1.set_title(activeFrontEnd.Name+' - PLL Sync')
ax1.plot(t, Theta, label='Theta')
ax1.set_ylim(-1, 10)
ax1.set_ylabel('theta [rad]')
